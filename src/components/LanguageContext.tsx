...
const translations = {
  tr: {
    ...
    'home.articles.card1.title': 'Sessizliğin Gücü',
    'home.articles.card1.snippet': 'Meydan okuyan, karşı duran, sessiz ama keskin varoluş. Ses çıkarmadan bile var olmak bir duruştur.',
    'home.articles.card2.title': 'Karşı Duruş',
    'home.articles.card2.snippet': 'Görünmezliğin içinde bile bir varlık, bir iz bırakmak. Bizim hikayemiz bu.',
...
Sesimiz var, varlığımız var. Sadece varız.`,
    ...
    'sample.story5.title': 'Non-Binary Olmak: İkiliğe Sığmamak',
...
Sadece varım. Tanımlanamaz ama gerçek.`,
    ...
    'sample.story6.title': 'Ailemle Barışmak',
...
Sadece var olmaya devam ettim. Ve onlar da öğreniyorlar.`,
    ...
    'sample.story7.title': 'Aşk Yaş Tanımaz',
...
Sadece varım. Ellimde, özgürce, mutluca.`,
    ...
    'sample.story8.title': "Pride'da İlk Defa",
...
Ve ben bağırıyorum: SADECE VARIM!`,
  ...
  en: {
    ...
    'home.articles.card1.title': 'The Power of Silence',
    'home.articles.card1.snippet': 'A defiant, opposing, quiet but sharp existence. Being without making a sound can itself be a stance.',
    'home.articles.card2.title': 'Opposing Stance',
    'home.articles.card2.snippet': 'Leaving a trace of existence even within invisibility — this is our story.',
...
export function LanguageProvider({ children }: { children: ReactNode }) {
  ...
  const t = (key: string): string => {
    const value = translations[language][key as keyof typeof translations.tr] || key;
    // If current language is Turkish, and English source for the key is ALL UPPERCASE,
    // return the Turkish translation also converted to uppercase (Turkish locale).
    if (language === 'tr') {
